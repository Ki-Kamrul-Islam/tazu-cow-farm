export const en = {
    ...
    calendar: {
        tabs: { alerts: "Alerts", view: "Calendar View" },
    },
    alert: {
        fields: {
            type: "Type",
        ...
        severity: { overdue: "Overdue", upcoming: "Upcoming" },
        list: {
            description: "What needs attention in the next 7 days",
            emptyTitle: "No alerts",
            emptyDescription: "Nothing urgent right now — all good!",
        },
    },
    calendarView: {
        description: "See all upcoming tasks at a glance on the calendar",
        previous: "Previous",
        next: "Next",
        today: "Today",
        todayLabel: "Today",
        emptyTitle: "No events",
        emptyDescription: "Nothing scheduled for this day",
        weekday: {
            sun: "Sun",
            mon: "Mon",
            tue: "Tue",
